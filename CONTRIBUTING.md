...
Cloning this repository and either placing it in or symlinking it to your `Data/systems/n5eb` user data directory is all that is necessary to run this within Foundry VTT. However, if you want to make changes to either the LESS stylesheets or the compendia, there are some developer tools which will make your life easier.
