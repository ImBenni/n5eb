...
export default class ActivityChoiceDialog extends Application5e {
  ...
  static PARTS = {
    activities: {
      template: "systems/n5eb/templates/activity/activity-choices.hbs"
    }
  };
  ...
  async _prepareContext(options) {
    let controlHint;
    if ( game.settings.get("n5eb", "controlHints") ) {
      controlHint = game.i18n.localize("DND5E.Controls.Activity.FastForwardHint");
      controlHint = controlHint.replace(
        "<left-click>",
        `<img src="systems/n5eb/icons/svg/mouse-left.svg" alt="${game.i18n.localize("DND5E.Controls.LeftClick")}">`
      );
    }
