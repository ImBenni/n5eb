...
export default class ActivityUsageDialog extends Dialog5e {
  ...
  static PARTS = {
    scaling: {
      template: "systems/n5eb/templates/activity/activity-usage-scaling.hbs"
    },
    concentration: {
      template: "systems/n5eb/templates/activity/activity-usage-concentration.hbs"
    },
    consumption: {
      template: "systems/n5eb/templates/activity/activity-usage-consumption.hbs"
    },
    creation: {
      template: "systems/n5eb/templates/activity/activity-usage-creation.hbs"
    },
    footer: {
  ...
  async _prepareConcentrationContext(context, options) {
    if ( !this.activity.requiresConcentration || game.settings.get("n5eb", "disableConcentration")
