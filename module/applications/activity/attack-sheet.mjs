...
export default class AttackSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    identity: {
      template: "systems/n5eb/templates/activity/attack-identity.hbs",
      templates: [
        ...super.PARTS.identity.templates,
        "systems/n5eb/templates/activity/parts/attack-identity.hbs"
      ]
    },
    effect: {
      template: "systems/n5eb/templates/activity/attack-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/n5eb/templates/activity/parts/attack-damage.hbs",
        "systems/n5eb/templates/activity/parts/attack-details.hbs",
