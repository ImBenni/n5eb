...
export default class CastSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/n5eb/templates/activity/cast-effect.hbs",
      templates: [
        "systems/n5eb/templates/activity/parts/cast-spell.hbs",
        "systems/n5eb/templates/activity/parts/cast-details.hbs"
      ]
    }
  };
