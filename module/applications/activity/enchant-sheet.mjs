...
export default class EnchantSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/n5eb/templates/activity/enchant-effect.hbs",
      templates: [
        "systems/n5eb/templates/activity/parts/enchant-enchantments.hbs",
        "systems/n5eb/templates/activity/parts/enchant-restrictions.hbs"
      ]
    }
  };
