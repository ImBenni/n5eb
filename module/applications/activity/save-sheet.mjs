...
export default class SaveSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/n5eb/templates/activity/save-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/n5eb/templates/activity/parts/damage-part.hbs",
        "systems/n5eb/templates/activity/parts/damage-parts.hbs",
        "systems/n5eb/templates/activity/parts/save-damage.hbs",
        "systems/n5eb/templates/activity/parts/save-details.hbs",
        "systems/n5eb/templates/activity/parts/save-effect-settings.hbs"
      ]
    }
  };
  ...
  _prepareAppliedEffectContext(context, effect) {
    effect.additionalSettings = "systems/n5eb/templates/activity/parts/save-effect-settings.hbs";
    return effect;
  }
