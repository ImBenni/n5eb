...
export default class SummonSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/n5eb/templates/activity/summon-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/n5eb/templates/activity/parts/summon-changes.hbs",
        "systems/n5eb/templates/activity/parts/summon-profiles.hbs"
      ]
    }
  };
