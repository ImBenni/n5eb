...
export default class TransformSheet extends ActivitySheet {
  ...
  static PARTS = {
    ...super.PARTS,
    effect: {
      template: "systems/n5eb/templates/activity/transform-effect.hbs",
      templates: [
        ...super.PARTS.effect.templates,
        "systems/n5eb/templates/activity/parts/transform-profiles.hbs",
        "systems/n5eb/templates/activity/parts/transform-settings.hbs"
      ]
    }
  };
