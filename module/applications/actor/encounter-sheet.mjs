...
export default class EncounterActorSheet extends MultiActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/n5eb/templates/actors/encounter/header.hbs"
    },
    tabs: {
    ...
    members: {
      ...
      template: "systems/n5eb/templates/actors/encounter/members.hbs",
      scrollable: [""]
    },
    inventory: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/n5eb/templates/actors/tabs/actor-inventory.hbs",
      templates: ["systems/n5eb/templates/inventory/inventory.hbs"],
      scrollable: [""]
    },
    description: {
      container: { classes: ["tab-body"], id: "tabs" },
