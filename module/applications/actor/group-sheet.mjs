...
export default class GroupActorSheet extends MultiActorSheet {
  ...
  static PARTS = {
    header: {
      template: "systems/n5eb/templates/actors/group/header.hbs"
    },
    tabs: {
    ...
    members: {
      ...
      template: "systems/n5eb/templates/actors/group/members.hbs",
      templates: ["systems/n5eb/templates/actors/group/member.hbs"],
      scrollable: [""]
    },
    inventory: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/n5eb/templates/actors/group/inventory.hbs",
      templates: [
        "systems/n5eb/templates/inventory/inventory.hbs", "systems/n5eb/templates/inventory/activity.hbs",
        "systems/n5eb/templates/inventory/containers.hbs", "systems/n5eb/templates/inventory/encumbrance.hbs"
      ],
      scrollable: [".sidebar", ".body"]
    },
    biography: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/n5eb/templates/actors/group/biography.hbs",
      scrollable: [""]
    }
  };
  ...
  async _prepareHeaderContext(context, options) {
    context.showXP = game.settings.get("n5eb", "levelingMode") !== "noxp";
  ...
  async _prepareMemberEncumbrance(actor, context) {
    ...
    const systemUnits = game.settings.get("n5eb", "metricWeightUnits") ? "metric" : "imperial";
    context.encumbrance = {
      pct,
