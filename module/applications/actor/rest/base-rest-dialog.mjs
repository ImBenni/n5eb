...
export default class BaseRestDialog extends Dialog5e {
  ...
  static DEFAULT_OPTIONS = {
    ...
    templates: [
      "systems/n5eb/templates/actors/rest/parts/hit-dice.hbs",
      "systems/n5eb/templates/actors/rest/parts/rest-request.hbs"
    ]
  };
  ...
  static PARTS = {
    ...super.PARTS,
    content: {
      template: "systems/n5eb/templates/actors/rest/base-rest.hbs"
    }
  };
  ...
  get promptNewDay() {
    const duration = CONFIG.DND5E.restTypes[this.config.type]
      ?.duration?.[game.settings.get("n5eb", "restVariant")] ?? 0;
