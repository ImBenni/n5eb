...
export default class TransformDialog extends Dialog5e {
  ...
  static PARTS = {
    details: {
      template: "systems/n5eb/templates/apps/transform-details.hbs"
    },
    presets: {
      container: { id: "settings-area" },
      template: "systems/n5eb/templates/apps/transform-presets.hbs"
    },
    settings: {
      container: { id: "settings-area" },
      template: "systems/n5eb/templates/apps/transform-settings.hbs"
    },
    footer: {
