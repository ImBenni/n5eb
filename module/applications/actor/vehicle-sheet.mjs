...
export default class VehicleActorSheet extends BaseActorSheet {
  ...
  static PARTS = {
    ...
    sidebar: {
      template: "systems/n5eb/templates/actors/vehicle/sidebar.hbs",
      templates: [
        "systems/n5eb/templates/actors/parts/actor-trait-line.hbs",
        "systems/n5eb/templates/actors/parts/actor-trait-pills.hbs"
      ],
      scrollable: [""]
    },
    stations: {
      template: "systems/n5eb/templates/actors/vehicle/stations.hbs",
    ...
    crew: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/n5eb/templates/actors/vehicle/crew.hbs",
      scrollable: [""]
    },
    effects: {
      container: { classes: ["tab-body"], id: "tabs" },
    ...
    description: {
      container: { classes: ["tab-body"], id: "tabs" },
      template: "systems/n5eb/templates/actors/vehicle/description.hbs",
      scrollable: [""]
    }
  };
  ...
  /** @override */
  static TABS = [
    { tab: "inventory", label: "DND5E.VEHICLE.Tabs.Cargo", svg: "systems/n5eb/icons/svg/backpack.svg" },
