...
export default class AbilityScoreImprovementConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...super.PARTS,
    details: {
      template: "systems/n5eb/templates/advancement/ability-score-improvement-config-details.hbs"
    },
    scores: {
      template: "systems/n5eb/templates/advancement/ability-score-improvement-config-scores.hbs",
      templates: ["systems/n5eb/templates/advancement/parts/advancement-ability-score-control.hbs"]
    }
  };
