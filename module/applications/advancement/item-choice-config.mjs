...
export default class ItemChoiceConfig extends AdvancementConfig {
  ...
  static PARTS = {
    config: {
      ...
      template: "systems/n5eb/templates/advancement/advancement-controls-section.hbs"
    },
    details: {
      container: { classes: ["column-container"], id: "column-left" },
      template: "systems/n5eb/templates/advancement/item-choice-config-details.hbs"
    },
    spellConfig: {
      container: { classes: ["column-container"], id: "column-left" },
      template: "systems/n5eb/templates/advancement/advancement-spell-config-section.hbs"
    },
    items: {
      container: { classes: ["column-container"], id: "column-center" },
      template: "systems/n5eb/templates/advancement/item-choice-config-items.hbs"
    },
    levels: {
      container: { classes: ["column-container"], id: "column-right" },
      template: "systems/n5eb/templates/advancement/item-choice-config-levels.hbs"
    }
  };
