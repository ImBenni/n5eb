...
export default class TraitConfig extends AdvancementConfig {
  ...
  static PARTS = {
    ...
    details: {
      container: { classes: ["column-container"], id: "column-left" },
      template: "systems/n5eb/templates/advancement/trait-config-details.hbs"
    },
    guaranteed: {
      container: { classes: ["column-container"], id: "column-left" },
      template: "systems/n5eb/templates/advancement/trait-config-guaranteed.hbs"
    },
    choices: {
      container: { classes: ["column-container"], id: "column-left" },
      template: "systems/n5eb/templates/advancement/trait-config-choices.hbs"
    },
    traits: {
      container: { classes: ["column-container"], id: "column-right" },
      template: "systems/n5eb/templates/advancement/trait-config-traits.hbs"
    }
  };
