...
export default class Award extends Application5e {
  ...
  static PARTS = {
    award: {
      template: "systems/n5eb/templates/apps/award.hbs"
    }
  };
  ...
  async _prepareContext(options) {
    ...
    context.hideXP = game.settings.get("n5eb", "levelingMode") === "noxp";
  ...
  static prepareDestinations(destinations, savedDestinations) {
    const icons = {
      container: '<dnd5e-icon class="fa-fw" src="systems/n5eb/icons/svg/backpack.svg"></dnd5e-icon>',
