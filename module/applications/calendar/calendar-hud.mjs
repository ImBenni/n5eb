...
export default class CalendarHUD extends BaseCalendarHUD {
  ...
  static PARTS = {
    startButtons: {
      ...
      template: "systems/n5eb/templates/apps/calendar-buttons.hbs"
    },
    core: {
      classes: ["calendar-core"],
      template: "systems/n5eb/templates/apps/calendar-core.hbs"
    },
    endButtons: {
      classes: ["calendar-buttons"],
      template: "systems/n5eb/templates/apps/calendar-buttons.hbs"
  ...
  async renderCore(deltas={}) {
    const prefs = game.settings.get("n5eb", "calendarPreferences");
