...
export default class CompendiumBrowser extends Application5e {
  ...
  static PARTS = {
    header: {
      id: "header",
      classes: ["header"],
      template: "systems/n5eb/templates/compendium/browser-header.hbs"
    },
    search: {
      id: "sidebar-search",
      classes: ["filter-element"],
      container: { id: "sidebar", classes: ["sidebar", "flexcol"] },
      template: "systems/n5eb/templates/compendium/browser-sidebar-search.hbs"
    },
    types: {
      id: "sidebar-types",
      container: { id: "sidebar", classes: ["sidebar", "flexcol"] },
      template: "systems/n5eb/templates/compendium/browser-sidebar-types.hbs"
    },
    filters: {
      id: "sidebar-filters",
      container: { id: "sidebar", classes: ["sidebar", "flexcol"] },
    ...
    results: {
      id: "results",
      classes: ["results"],
      template: "systems/n5eb/templates/compendium/browser-results.hbs",
      templates: ["systems/n5eb/templates/compendium/browser-entry.hbs"],
      scrollable: [""]
    },
    footer: {
      id: "footer",
      classes: ["footer"],
      template: "systems/n5eb/templates/compendium/browser-footer.hbs"
    },
    tabs: {
      id: "tabs",
      classes: ["tabs", "tabs-left"],
      template: "systems/n5eb/templates/compendium/browser-tabs.hbs"
    }
  };
  ...
  static TABS = [
    {
      ...
      svg: "systems/n5eb/icons/svg/items/class.svg",
      documentClass: "Item",
      types: ["class"]
    },
    {
      ...
      svg: "systems/n5eb/icons/svg/items/subclass.svg",
      documentClass: "Item",
      types: ["subclass"]
    },
    {
    ...
    },
    {
      ...
      svg: "systems/n5eb/icons/svg/items/background.svg",
      documentClass: "Item",
      types: ["background"]
    },
    {
      ...
      svg: "systems/n5eb/icons/svg/backpack.svg",
      documentClass: "Item",
      types: ["physical"]
    },
    {
    ...
    },
    {
      ...
      svg: "systems/n5eb/icons/svg/actors/npc.svg",
      documentClass: "Actor",
      types: ["npc"]
    },
    {
      ...
      svg: "systems/n5eb/icons/svg/actors/vehicle.svg",
      documentClass: "Actor",
      types: ["vehicle"]
    },
    {
  ...
  async _renderResult(entry, documentClass) {
    ...
    const html = await foundry.applications.handlebars.renderTemplate(
      "systems/n5eb/templates/compendium/browser-entry.hbs", context
    );
  ...
  async _renderSourceFilters() {
    ...
    const filter = await foundry.applications.handlebars.renderTemplate(
      "systems/n5eb/templates/compendium/browser-sidebar-filter-set.hbs",
      {
        locked,
  ...
  static async fetch(documentClass, { types=new Set(), filters=[], index=true, indexFields=new Set(), sort=true }={}) {
    ...
    let documents = game.packs
      ...
      .filter(p => (p.metadata.type === documentClass.metadata.name)
        ...
        && (!types.size || !p.metadata.flags.n5eb?.types || new Set(p.metadata.flags.n5eb.types).intersects(types)))
      ...
      .map(async p => await Promise.all((await p.getIndex({ fields: Array.from(indexFields) })
        ...
        .filter(i =>
          (!types.size || (types.has(i.type)
            && (!p.metadata.flags.n5eb?.types || p.metadata.flags.n5eb.types.includes(i.type))))
