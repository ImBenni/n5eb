...
export default class InventoryElement extends (foundry.applications.elements.AdoptableHTMLElement ?? HTMLElement) {
  ...
  static COLUMNS = {
    capacity: {
      ...
      order: 800,
      priority: 1000,
      template: "systems/n5eb/templates/inventory/columns/capacity.hbs"
    },
    charges: {
      id: "charges",
      width: 70,
    ...
    controls: {
      ...
      order: 1000,
      priority: 1000,
      template: "systems/n5eb/templates/inventory/columns/controls.hbs"
    },
    formula: {
      id: "formula",
      width: 80,
    ...
    price: {
      ...
      priority: 300,
      label: "DND5E.Price",
      template: "systems/n5eb/templates/inventory/columns/price.hbs"
    },
    range: {
      id: "range",
      width: 50,
      ...
      template: "systems/n5eb/templates/inventory/columns/range.hbs"
    },
    recovery: {
      id: "recovery",
      width: 60,
      ...
      template: "systems/n5eb/templates/inventory/columns/recovery.hbs"
    },
    roll: {
      id: "roll",
      width: 40,
      ...
      template: "systems/n5eb/templates/inventory/columns/roll.hbs"
    },
    school: {
      id: "school",
      width: 40,
      ...
      template: "systems/n5eb/templates/inventory/columns/school.hbs"
    },
    target: {
      id: "target",
      width: 80,
      ...
      template: "systems/n5eb/templates/inventory/columns/target.hbs"
    },
    time: {
      id: "time",
      width: 40,
      ...
      template: "systems/n5eb/templates/inventory/columns/time.hbs"
    },
    quantity: {
      id: "quantity",
      width: 70,
      ...
      template: "systems/n5eb/templates/inventory/columns/quantity.hbs"
    },
    uses: {
      id: "uses",
      width: 70,
    ...
    weight: {
      ...
      priority: 400,
      label: "DND5E.Weight",
      template: "systems/n5eb/templates/inventory/columns/weight.hbs"
    }
  };
  ...
  _getContextOptions(item, element) {
    ...
    options.push({
      ...
      icon: '<dnd5e-icon src="systems/n5eb/icons/svg/break-concentration.svg"></dnd5e-icon>',
  ...
  async _onToggleExpand(target, { item }={}) {
    ...
    if ( !this.app.expandedSections ) {
      ...
      if ( this.app._expanded.has(item.id) ) {
        ...
        const summary = $(await foundry.applications.handlebars.renderTemplate(
          "systems/n5eb/templates/items/parts/item-summary.hbs", chatData
        ));
    ...
    if ( expanded ) {
      ...
      const template = "systems/n5eb/templates/items/parts/item-summary.hbs";
