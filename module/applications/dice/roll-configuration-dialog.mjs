...
export default class RollConfigurationDialog extends Dialog5e {
  ...
  static PARTS = {
    formulas: {
      template: "systems/n5eb/templates/dice/roll-formulas.hbs"
    },
    configuration: {
      template: "systems/n5eb/templates/dice/roll-configuration.hbs"
    },
    buttons: {
      template: "systems/n5eb/templates/dice/roll-buttons.hbs"
    }
  };
  ...
  _identifyDiceTerms() {
    ...
    const identifyTerm = term => {
      ...
      for ( let i = 0; i < term.number; i++ ) dice.push({
        icon: `systems/n5eb/icons/svg/dice/${term.denomination}.svg`,
