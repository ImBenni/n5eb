...
export default class ItemSheet5e extends PrimarySheetMixin(DocumentSheet5e) {
  ...
  static PARTS = {
    header: {
      template: "systems/n5eb/templates/items/header.hbs"
    },
    tabs: {
      template: "systems/n5eb/templates/shared/horizontal-tabs.hbs",
      templates: ["templates/generic/tab-navigation.hbs"]
    },
    activities: {
      template: "systems/n5eb/templates/items/activities.hbs",
      templates: [
        "systems/n5eb/templates/inventory/columns/uses.hbs",
        "systems/n5eb/templates/shared/activities.hbs"
      ],
      scrollable: [""]
    },
    advancement: {
      template: "systems/n5eb/templates/items/advancement.hbs",
      scrollable: [""]
    },
    description: {
      template: "systems/n5eb/templates/items/description.hbs",
      scrollable: [""]
    },
    details: {
      template: "systems/n5eb/templates/items/details.hbs",
      scrollable: [""]
    },
    effects: {
      template: "systems/n5eb/templates/items/effects.hbs",
      scrollable: [""]
    }
  };
  ...
  async _onDropAdvancement(event, data) {
    ...
    if ( this.item.actor?.system.metadata?.supportsAdvancement && !game.settings.get("n5eb", "disableAdvancements") ) {
