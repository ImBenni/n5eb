...
export default class JournalSpellListPageSheet extends JournalEntryPageHandlebarsSheet {
  ...
  static EDIT_PARTS = {
    ...
    config: {
      ...
      template: "systems/n5eb/templates/journal/spell/config.hbs"
    },
    list: {
      classes: ["right", "spell-list"],
      template: "systems/n5eb/templates/journal/spell/list.hbs"
    }
  };
  ...
  static VIEW_PARTS = {
    content: {
      root: true,
      template: "systems/n5eb/templates/journal/spell/view.hbs"
    }
  };
  ...
  _configureRenderParts(options) {
    ...
    if ( ("content" in parts) && this.options.displayAsTable ) {
      parts.content.template = "systems/n5eb/templates/journal/spell/table.hbs";
    }
    return parts;
  }
