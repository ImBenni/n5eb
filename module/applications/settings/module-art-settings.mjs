...
export default class ModuleArtSettingsConfig extends FormApplication {
  ...
  constructor(object={}, options={}) {
    object = foundry.utils.mergeObject(game.settings.get("n5eb", "moduleArtConfiguration"), object, {inplace: false});
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      ...
      template: "systems/n5eb/templates/apps/module-art-config.hbs",
      popOut: true,
      width: 600,
      height: "auto"
    });
  ...
  async _updateObject(event, formData) {
    await game.settings.set("n5eb", "moduleArtConfiguration", foundry.utils.expandObject(formData));
