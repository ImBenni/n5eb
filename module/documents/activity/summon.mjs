...
export default class SummonActivity extends ActivityMixin(BaseSummonActivityData) {
  ...
  static metadata = Object.freeze(
    foundry.utils.mergeObject(super.metadata, {
      type: "summon",
      img: "systems/n5eb/icons/svg/activity/summon.svg",
   ...
   */
  get canSummon() {
    return game.user.can("TOKEN_CREATE") && (game.user.isGM || game.settings.get("n5eb", "allowSummoning"));
  }
