...
export function areKeysPressed(event, action) {
  ...
  return game.keybindings.get("n5eb", action).some(b => {
...
export function defaultUnits(type) {
  ...
  return CONFIG.DND5E.defaultUnits[type]?.[game.settings.get("n5eb", settingKey) ? "metric" : "imperial"];
}
...
export async function preloadHandlebarsTemplates() {
  const partials = [
    ...
    "systems/n5eb/templates/apps/parts/traits-list.hbs",

    // Actor Sheet Partials
    "systems/n5eb/templates/actors/parts/actor-classes.hbs",
    "systems/n5eb/templates/actors/parts/actor-trait-pills.hbs",
    "systems/n5eb/templates/actors/parts/actor-traits.hbs",
    "systems/n5eb/templates/actors/parts/actor-features.hbs",
    "systems/n5eb/templates/actors/parts/actor-spellbook.hbs",
    "systems/n5eb/templates/actors/parts/actor-warnings.hbs",
    "systems/n5eb/templates/actors/parts/actor-warnings-dialog.hbs",
    "systems/n5eb/templates/actors/parts/biography-textbox.hbs",
    "systems/n5eb/templates/actors/tabs/character-bastion.hbs",
    "systems/n5eb/templates/actors/tabs/character-biography.hbs",
    "systems/n5eb/templates/actors/tabs/character-details.hbs",
    "systems/n5eb/templates/actors/tabs/creature-special-traits.hbs",
    "systems/n5eb/templates/actors/tabs/npc-biography.hbs",

    // Chat Message Partials
    "systems/n5eb/templates/chat/parts/card-activities.hbs",
    "systems/n5eb/templates/chat/parts/card-deltas.hbs",
    ...
    "systems/n5eb/templates/items/details/details-starting-equipment.hbs",
    "systems/n5eb/templates/items/details/details-subclass.hbs",
    "systems/n5eb/templates/items/details/details-tool.hbs",
    "systems/n5eb/templates/items/details/details-weapon.hbs",
    "systems/n5eb/templates/items/parts/item-summary.hbs",
    "systems/n5eb/templates/items/parts/item-tooltip.hbs",
    "systems/n5eb/templates/items/parts/spell-block.hbs",

    // Field Partials
    "systems/n5eb/templates/shared/fields/field-activation.hbs",
    "systems/n5eb/templates/shared/fields/field-damage.hbs",
    "systems/n5eb/templates/shared/fields/field-duration.hbs",
    "systems/n5eb/templates/shared/fields/field-range.hbs",
    "systems/n5eb/templates/shared/fields/field-targets.hbs",
    "systems/n5eb/templates/shared/fields/field-uses.hbs",
    "systems/n5eb/templates/shared/fields/fieldlist.hbs",
    "systems/n5eb/templates/shared/fields/formlist.hbs",

    // Journal Partials
    "systems/n5eb/templates/journal/parts/journal-legacy-traits.hbs",
    "systems/n5eb/templates/journal/parts/journal-modern-traits.hbs",
    "systems/n5eb/templates/journal/parts/journal-table.hbs",

    // Activity Partials
    "systems/n5eb/templates/activity/parts/activity-usage-notes.hbs",
